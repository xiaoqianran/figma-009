...
/// Figma Wallet frame balance section with quick actions.
class WalletBalanceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(MockWalletTokens.walletLabel, style: labelStyle),
          const SizedBox(height: DesignConstants.spacing8),
          Text(MockWalletTokens.totalBalance, style: balanceStyle),
