...
| `test/features/settings/settings_security_flow_test.dart` | 4 | Auto-Lock / Method / Price Alerts |
| `test/shared/widgets/cells/wallet_selection_cell_test.dart` | 2 | Security radio selection cell |
